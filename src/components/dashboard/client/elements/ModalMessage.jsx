            ...
            <div className="modal-header">
                <div className="image-container">
                    <img className="image-craftsman" 
                        src={selectedUserConversation.profile_img?.img_path ? `${apiBase}/storage/${selectedUserConversation.profile_img.img_path}` : DefaultCraftsman}
                        alt={selectedUserConversation.profile_img?.img_title ? selectedUserConversation.profile_img?.img_title : 'Image utilisateur'}
                        />
                </div>
                <div className="user-name-job">
                    ...
                    <Badge color="info">{selectedUserConversation.craftsman?.job.name}</Badge>
                </div>
            </div>
