...
function PrestationsTab() {
    ...
    const clientAccept = async (prestationId) => {
        // Empty alert message
        setAlertMessage(defaultAlertMessage);
        setIsLoadingConfirm(true);

        try {
            const response = await axios.patch(`${apiBase}/api/prestation/${prestationId}/accept`,
                {},
    ...
    const clientRefuse = async (prestationId) => {
        // Empty alert message
        setAlertMessage(defaultAlertMessage);
        setIsLoadingCancel(true);

        try {
            const response = await axios.patch(`${apiBase}/api/prestation/${prestationId}/client-refuse`,
                {},
                { headers: {"Authorization": "Bearer " + userToken} 
            })
                                                            ...
                                                            <div className="suggestion-content">
                                                                ...
                                                                <p className="suggestion-date">
                                                                    {selectedPrestation.date ?
                                                                        dateLong(selectedPrestation.date)
                                                                    : "Date non définie"}
                                                                </p>
                                                            </div>
                                                        </div>
                                                            ...
                                                            <>
                                                                <div className="state-card card pending">
                                                                    ...
                                                                    <div className="state-content">
                                                                        ...
                                                                        <p className="state-description">L'artisan vous a répondu ! Vous devez accepter ou décliner sa proposition</p>
                                                                    </div>
                                                                </div>
                                                                ...
                                                                <div className="info-card card">
                                                                    ...
                                                                    <div className="info-content">
                                                                        ...
                                                                        <ul className="info-list">
                                                                            ...
                                                                            <li><FontAwesomeIcon icon={faCaretRight} /> Restez disponible</li>
                                                                        </ul>
                                                                    </div>
                                                                </div>
                                                            </>
                                                                ...
                                                                <div className="info-card card">
                                                                    ...
                                                                    <div className="info-content">
                                                                        ...
                                                                        <ul className="info-list">
                                                                            ...
                                                                            <li><FontAwesomeIcon icon={faCaretRight} /> Chercher un autre artisan si besoin</li>
                                                                        </ul>
                                                                    </div>
                                                                </div>
                                                            </>
                                                        ...
                                                        {selectedPrestation.state === 'refused-by-craftsman' &&
                                                            <>
                                                                <div className="state-card card refused">
                                                                    ...
                                                                    <div className="state-content">
                                                                        <h4>
                                                                            Refusé par {firstCapitalize(selectedPrestation.craftsman.user.first_name)}
                                                                        </h4>
                                                                        <p className="state-description">L'artisan a décliné votre demande</p>
                                                                    </div>
                                                                </div>
                                                                ...
                                                                <div className="info-card card">
                                                                    ...
                                                                    <div className="info-content">
                                                                        ...
                                                                        <ul className="info-list">
                                                                            ...
                                                                            <li><FontAwesomeIcon icon={faCaretRight} /> Modifier votre demande</li>
